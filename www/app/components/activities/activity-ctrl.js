(function () {
  ...
  function activityCtrl($state, $location, $scope, service, $stateParams,
    $rootScope, $ionicHistory, userService, sharedService, eventService) {
    ...
    function activate() {
      ...
      var id = localStorage.getItem('id'); // TODO-DEBUG, is this var going to be used?
